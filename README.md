...
Targets **Multica REST API v0.3.38**.
...
| `multica_list_tasks`          | List tasks with filters (project, status, assignee, assignee_types, query) |
...
internal/
  ...
  multica/                 HTTP client adapter for Multica API v0.3.38
